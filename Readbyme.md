...
## Type Narrowing or use type guard ([Narrowing](https://www.typescriptlang.org/docs/handbook/2/narrowing.html))
check type, dealing with precise type
...
```
```instasnceof```  useful for most values that can be constructed with ```new```.
...
Reference
This note is made with while learing from [This tutorial](https://www.youtube.com/watch?v=RBWe_ZlSzjQ&list=PLRAV69dS1uWRPSfKzwZsIm-Axxq-LxqhW&index=26)